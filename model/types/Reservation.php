...
class Reservation extends Base {
    public $reservationId, $userId, $listingId, $quantity, $status, $code, $timeCreated, $timeExpired, $lat, $lng, $listing;
    ...
    static $RESERVATION_STATUS_RETRIEVAL = 3;
    ...
    static $RETRIEVAL_RETURN_CODE_OUT_OF_RANGE = 4;
