...
1. Go to https://caslab.case.edu/cp/passreset.php. ![Pasted image 20251112111834.png](./Documentation/Pasted%20image%2020251112111834.png)
2. Enter in your email address and ``Continue``.
3. Check your Institute email for a verification code: ![Pasted image 20251112112202.png](./Documentation/Pasted%20image%2020251112112202.png)
4. Enter the verification code and construct a password. ![Pasted image 20251112112254.png](./Documentation/Pasted%20image%2020251112112254.png)

Congrats! You are now registered in the database as a user! When you log in, you should see this dashboard:
   ![Pasted image 20251112115621.png](./Documentation//Pasted%20image%2020251112115621.png)
