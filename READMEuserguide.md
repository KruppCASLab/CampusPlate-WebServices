...
As an admin, when you log in, you will see A dashboard that looks something like this.![[Pasted image 20251112115621.png]]
Notice the admin tab?
1. Navigate to the admin tab.

Now the User should be able to log in! Have attempt it to be sure. They should now see this dashboard: ![[Pasted image 20251112115621.png]]

# Managing your food stop
5. listing management:
6. Add a listing
7. Updating a listing
8. delete a listig 
=======
# Changing User permissions (Admin only)
